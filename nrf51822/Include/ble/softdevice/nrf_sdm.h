...
enum {
  SVC_SOFTDEVICE_ENABLE = SDM_SVC_BASE, /**< ::nrf_softdevice_enable */
  SVC_SOFTDEVICE_DISABLE,               /**< ::nrf_softdevice_disable */
  SVC_SOFTDEVICE_IS_ENABLED,            /**< ::nrf_softdevice_is_enabled */
 ...
 */
SVCALL(SVC_SOFTDEVICE_ENABLE, uint32_t, nrf_softdevice_enable(nrf_clock_lfclksrc_t clock_source, softdevice_assertion_handler_t assertion_handler));
 ...
 * @return ::NRF_SUCCESS
 */
SVCALL(SVC_SOFTDEVICE_DISABLE, uint32_t, nrf_softdevice_disable(void));
 ...
 * @return ::NRF_SUCCESS
 */
SVCALL(SVC_SOFTDEVICE_IS_ENABLED, uint32_t, nrf_softdevice_is_enabled(uint8_t * p_softdevice_enabled));
