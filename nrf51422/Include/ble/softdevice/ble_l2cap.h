...
enum 
{
  SVC_BLE_L2CAP_CID_REGISTER = BLE_L2CAP_SVC_BASE,  /**< Register a CID */
  SVC_BLE_L2CAP_CID_UNREGISTER,                     /**< Unregister a CID */
  SVC_BLE_L2CAP_TX                                  /**< Transmit a packet */
};
 ...
 */
SVCALL(SVC_BLE_L2CAP_CID_REGISTER, uint32_t, ble_l2cap_cid_register(uint16_t cid));
 ...
 */
SVCALL(SVC_BLE_L2CAP_CID_UNREGISTER, uint32_t, ble_l2cap_cid_unregister(uint16_t cid));
 ...
 */
SVCALL(SVC_BLE_L2CAP_TX, uint32_t, ble_l2cap_tx(uint16_t conn_handle, ble_l2cap_header_t const * const p_header, uint8_t const * const p_data));
